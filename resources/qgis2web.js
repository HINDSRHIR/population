...
map.getView().fit([-1101909.046792, 3463702.609862, -685311.791464, 3836926.888170], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte du recensement 2024 de la population pour la region Marrakech-Safi (by H.SRHIR)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (179 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'realisation d\'une carte choroplèthe interactive basée sur la variation de la population entre les différentes de la région de Marrakech Safi selon le recensement du septembre 2024';
            }
